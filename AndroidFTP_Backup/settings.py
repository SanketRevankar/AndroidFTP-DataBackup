"""
Django settings for AndroidFTP_Backup project.
...
SECRET_KEY = 'fjh=8bs8vf596%l^yekr(5sjr1pkfh&cy#ddl&i42__21%aa30'
...
ROOT_URLCONF = 'AndroidFTP_Backup.urls'
...
WSGI_APPLICATION = 'AndroidFTP_Backup.wsgi.application'
